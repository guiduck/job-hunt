...
from app.schemas.opportunity import Opportunity, OpportunityCreate, OpportunityListItem, OpportunityUpdate
from app.services.opportunity_service import create_opportunity, get_opportunity, list_opportunities, update_opportunity
