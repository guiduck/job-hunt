...
WORKER_SCHEMA = [
    ...
    CREATE TABLE job_search_runs (
        id VARCHAR(36) PRIMARY KEY,
        user_id VARCHAR(36) NOT NULL DEFAULT 'user-1',
        search_kind VARCHAR(50) NOT NULL DEFAULT 'linkedin',
        ...
        selected_source_keys JSON NOT NULL DEFAULT '[]',
        source_diagnostics JSON NOT NULL DEFAULT '{}',
        provided_source_count INTEGER NOT NULL,
        source_name VARCHAR(100) NOT NULL,
        candidate_limit INTEGER NOT NULL,
        accepted_limit INTEGER,
        inspected_cap INTEGER,
    ...
    CREATE TABLE job_search_candidates (
        ...
        poster_profile_url TEXT,
        application_url TEXT,
        application_kind VARCHAR(50),
        selected_source_key VARCHAR(100),
        source_name VARCHAR(100),
        provider_metadata JSON NOT NULL DEFAULT '{}',
