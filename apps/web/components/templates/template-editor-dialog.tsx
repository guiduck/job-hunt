...
export function TemplateEditorDialog() {
  ...
  function create(formData: FormData) {
    ...
    startTransition(async () => {
      ...
      if (!response.ok) {
        setMessage("Unable to create template.");
        return;
      }
  ...
  return (
    <form ref={formRef} action={create} className="space-y-3 rounded-lg border border-slate-800 bg-slate-950 p-4">
